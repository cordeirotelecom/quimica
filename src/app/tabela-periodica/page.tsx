...
const elements: Element[] = [
  ...
  // Período 4
  { symbol: 'K', name: 'Potássio', atomicNumber: 19, atomicMass: 39.0983, category: 'alkali-metal', period: 4, group: 1, electronConfiguration: '[Ar] 4s¹', density: 0.862, meltingPoint: 63.38, boilingPoint: 759, discoveryYear: 1807, discoverer: 'Humphry Davy', color: 'bg-gradient-to-br from-red-100 to-red-200 hover:from-red-200 hover:to-red-300', applications: ['Fertilizantes (KCl, K₂SO₄)', 'Vidro e cerâmica', 'Sabões e detergentes'], properties: ['Metal macio e prateado', 'Extremamente reativo com água', 'Flutua na água'], abundance: 'Sétimo elemento mais abundante na crosta terrestre (2.6%)', healthEffects: 'Essencial para função muscular, nervosa e regulação da pressão arterial', environmentalImpact: 'Abundante, essencial para plantas, reciclável' },
  { symbol: 'Ca', name: 'Cálcio', atomicNumber: 20, atomicMass: 40.078, category: 'alkaline-earth', period: 4, group: 2, electronConfiguration: '[Ar] 4s²', density: 1.54, meltingPoint: 842, boilingPoint: 1484, discoveryYear: 1808, discoverer: 'Humphry Davy', color: 'bg-gradient-to-br from-orange-100 to-orange-200 hover:from-orange-200 hover:to-orange-300', applications: ['Cimento Portland', 'Gesso e cal', 'Suplementos nutricionais'], properties: ['Metal alcalino-terroso', 'Reativo com água', 'Estrutural biológico fundamental'], abundance: 'Quinto elemento mais abundante na crosta terrestre (4.15%)', healthEffects: 'Essencial para ossos, dentes, contração muscular e coagulação sanguínea', environmentalImpact: 'Abundante, não tóxico, totalmente reciclável' },
  { symbol: 'Sc', name: 'Escândio', atomicNumber: 21, atomicMass: 44.9559, category: 'transition-metal', period: 4, group: 3, electronConfiguration: '[Ar] 3d¹ 4s²', density: 2.985, meltingPoint: 1541, boilingPoint: 2836, discoveryYear: 1879, discoverer: 'Lars Fredrik Nilson', color: 'bg-gradient-to-br from-blue-100 to-blue-200 hover:from-blue-200 hover:to-blue-300', applications: ['Ligas de alumínio aeroespaciais', 'Lâmpadas de haleto metálico', 'Equipamentos esportivos de alta performance'], properties: ['Metal leve e resistente', 'Terra rara', 'Oxidação superficial'], abundance: '50º elemento em abundância (22 ppm)', healthEffects: 'Baixa toxicidade, poucos estudos de segurança', environmentalImpact: 'Raro, mineração especializada' },
  { symbol: 'Ti', name: 'Titânio', atomicNumber: 22, atomicMass: 47.867, category: 'transition-metal', period: 4, group: 4, electronConfiguration: '[Ar] 3d² 4s²', density: 4.506, meltingPoint: 1668, boilingPoint: 3287, discoveryYear: 1791, discoverer: 'William Gregor', color: 'bg-gradient-to-br from-blue-100 to-blue-200 hover:from-blue-200 hover:to-blue-300', applications: ['Implantes médicos e próteses', 'Indústria aeroespacial (Boeing 787)', 'Equipamentos esportivos premium'], properties: ['Extremamente resistente (força do aço, leveza do alumínio)', 'Biocompatível perfeito', 'Resistente à corrosão marinha'], abundance: '9º elemento mais abundante na crosta terrestre (0.63%)', healthEffects: 'Perfeitamente biocompatível, usado em implantes cardíacos', environmentalImpact: 'Reciclável 100%, baixo impacto ambiental' },
  { symbol: 'V', name: 'Vanádio', atomicNumber: 23, atomicMass: 50.9415, category: 'transition-metal', period: 4, group: 5, electronConfiguration: '[Ar] 3d³ 4s²', density: 6.11, meltingPoint: 1910, boilingPoint: 3407, discoveryYear: 1801, discoverer: 'Andrés Manuel del Río', color: 'bg-gradient-to-br from-blue-100 to-blue-200 hover:from-blue-200 hover:to-blue-300', applications: ['Aço vanádio (85% da produção)', 'Catalisadores industriais', 'Baterias de vanádio redox'], properties: ['Endurece extremamente o aço', 'Múltiplos estados de oxidação', 'Cores variadas em solução'], abundance: '22º elemento em abundância (120 ppm)', healthEffects: 'Essencial em traços, tóxico em doses altas', environmentalImpact: 'Reciclagem do aço recupera vanádio' }
  { symbol: 'Cr', name: 'Cromo', atomicNumber: 24, atomicMass: 51.9961, category: 'transition-metal', period: 4, group: 6, electronConfiguration: '[Ar] 3d⁵ 4s¹', density: 7.15, meltingPoint: 1907, boilingPoint: 2671, discoveryYear: 1797, discoverer: 'Louis Nicolas Vauquelin', color: 'bg-gradient-to-br from-blue-100 to-blue-200 hover:from-blue-200 hover:to-blue-300', applications: ['Aço inoxidável (18% Cr)', 'Cromagem decorativa e protetiva', 'Pigmentos (verde cromo, amarelo cromo)'], properties: ['Extremamente duro (9 Mohs)', 'Resistente à corrosão e oxidação', 'Cores variadas dos compostos'], abundance: '21º elemento mais abundante (102 ppm)', healthEffects: 'Cr³⁺ essencial para metabolismo da glicose, Cr⁶⁺ carcinogênico', environmentalImpact: 'Cr⁶⁺ é altamente tóxico ambiental, requer tratamento especial' },
  { symbol: 'Mn', name: 'Manganês', atomicNumber: 25, atomicMass: 54.9380, category: 'transition-metal', period: 4, group: 7, electronConfiguration: '[Ar] 3d⁵ 4s²', density: 7.21, meltingPoint: 1246, boilingPoint: 2061, discoveryYear: 1774, discoverer: 'Johan Gottlieb Gahn', color: 'bg-gradient-to-br from-blue-100 to-blue-200 hover:from-blue-200 hover:to-blue-300', applications: ['Desoxidação do aço (90% do uso)', 'Pilhas secas (MnO₂)', 'Permanganato de potássio (antiséptico)'], properties: ['Quebradiço em temperatura ambiente', 'Estados de oxidação +2 a +7', 'Magnético paramagnético'], abundance: '12º elemento mais abundante (950 ppm)', healthEffects: 'Essencial como cofator enzimático, neurotóxico em excesso', environmentalImpact: 'Reciclável através do aço, mineração pode causar problemas neurológicos' },
  { symbol: 'Fe', name: 'Ferro', atomicNumber: 26, atomicMass: 55.845, category: 'transition-metal', period: 4, group: 8, electronConfiguration: '[Ar] 3d⁶ 4s²', density: 7.874, meltingPoint: 1538, boilingPoint: 2861, discoveryYear: -1500, discoverer: 'Conhecido desde a Idade do Ferro', color: 'bg-gradient-to-br from-blue-100 to-blue-200 hover:from-blue-200 hover:to-blue-300', applications: ['Aço carbono e ligas', 'Construção civil e infraestrutura', 'Hemoglobina (transporte de O₂)'], properties: ['Ferromagnético (permanente)', 'Base da siderurgia mundial', 'Oxida facilmente (ferrugem)'], abundance: '4º elemento mais abundante na crosta terrestre (5.63%)', healthEffects: 'Essencial para transporte de oxigênio e metabolismo energético', environmentalImpact: 'Altamente reciclável (45% do aço vem de sucata)' },
  { symbol: 'Co', name: 'Cobalto', atomicNumber: 27, atomicMass: 58.9332, category: 'transition-metal', period: 4, group: 9, electronConfiguration: '[Ar] 3d⁷ 4s²', density: 8.90, meltingPoint: 1495, boilingPoint: 2927, discoveryYear: 1735, discoverer: 'Georg Brandt', color: 'bg-gradient-to-br from-blue-100 to-blue-200 hover:from-blue-200 hover:to-blue-300', applications: ['Baterias de íon-lítio (LiCoO₂)', 'Ligas de alta temperatura', 'Vitamina B₁₂ (cobalamina)'], properties: ['Ferromagnético como ferro', 'Azul cobalto característico', 'Resistente à corrosão'], abundance: '32º elemento em abundância (25 ppm)', healthEffects: 'Essencial como centro da vitamina B₁₂', environmentalImpact: 'Mineração problemática (trabalho infantil no Congo)' },
  { symbol: 'Ni', name: 'Níquel', atomicNumber: 28, atomicMass: 58.6934, category: 'transition-metal', period: 4, group: 10, electronConfiguration: '[Ar] 3d⁸ 4s²', density: 8.912, meltingPoint: 1455, boilingPoint: 2913, discoveryYear: 1751, discoverer: 'Axel Fredrik Cronstedt', color: 'bg-gradient-to-br from-blue-100 to-blue-200 hover:from-blue-200 hover:to-blue-300', applications: ['Aço inoxidável austenítico', 'Moedas (euro, dólar canadense)', 'Baterias NiMH e Li-ion'], properties: ['Ferromagnético até 358°C', 'Resistente à corrosão em ambiente marinho', 'Maleável e dúctil'], abundance: '24º elemento mais abundante (84 ppm)', healthEffects: 'Pode causar dermatite alérgica (alergia a níquel)', environmentalImpact: 'Altamente reciclável, 40% vem de sucata' }
