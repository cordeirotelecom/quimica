...
const elements: Element[] = [
  ...
  // Período 7
  { symbol: 'Fr', name: 'Frâncio', atomicNumber: 87, atomicMass: 223, category: 'alkali-metal', period: 7, group: 1, electronConfiguration: '[Rn] 7s¹', density: 1.87, meltingPoint: 27, boilingPoint: 677, discoveryYear: 1939, descoberer: 'Marguerite Perey', color: 'bg-gradient-to-br from-red-100 to-red-200 hover:from-red-200 hover:to-red-300', applications: ['Pesquisa científica', 'Estudos atômicos'], properties: ['Extremamente radioativo', 'Vida curta', 'Raro'], abundance: 'Extremamente raro', healthEffects: 'Altamente radioativo e perigoso', environmentalImpact: 'Radioativo' },
