      ...
      <section className="px-6 py-20 max-w-7xl mx-auto text-center">
        <div className="mb-8">
          ...
          <p className="text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            Aprenda química de forma interativa e divertida! Experimentos virtuais seguros, 
            simulações 3D moleculares, calculadoras precisas e uma IA tutora para todas as idades.
          </p>
        </div>
